...
<table class="ket">
    <tr>
        <th class="aleft">PT</th><th> : </th>
        <th class="aleft"><?php 
            if($data_post['pilih_pt'] == 'Y')
            {
                echo "(Semua PT)";
            }else{
                echo $data_assets_ket['alias'];
            }
        ?></th>
        <th class="spc">------------</th>
        <th class="aleft">Kategori</th><th> : </th>
        <th class="aleft"><?php
            if($data_post['pilih_category'] == 'Y')
            {
                echo "(Semua Kategori)";
            }else{
                echo $data_assets_ket['category'];
            }
        ?></th>
        <th class="spc">------------</th>
        <th class="aleft">Idle</th><th> : </th>
        <th class="aleft"><?php 
            if($data_post['cb_idle'] == NULL)
            {
                echo '-';
            } else{
                echo "Ya";
    ...
    <tr>
        <th class="aleft">Kondisi</th><th> : </th>
        <th class="aleft"><?php
            if($data_post['pilih_kondisi'] == 'Y')
            {
                echo "(Semua Kondisi)";
            } elseif($data_post['pilih_kondisi'] == 1)
            {
                echo "Baik";
            }else{
                echo "Rusak";
        ...
        ?></th>
        <th class="spc">------------</th>
        <th class="aleft">Status</th><th> : </th>
        <th class="aleft"><?php
            if($data_post['status_unit'] == 'Y')
            {
                echo "(Semua Status)";
            }elseif($data_post['status_unit'] == '1')
            {
                echo "Tersedia";
            }else{
                echo "Dipinjam";

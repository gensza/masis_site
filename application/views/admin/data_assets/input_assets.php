                                ...
                                <div class="modal-body">
                                    <div class="row">
                                        ...
                                        <div class="form-group col-3">
                                            ...
                                            <input type="text" class="form-control" id="kode_asset" name="kode_asset" placeholder="Kode Asset">
                                        </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group mt-2 col-4">
                                            ...
                                            <input type="text" class="form-control bg-light" id="no_ba" name="no_ba" placeholder="NO BA" readonly>
                                        </div>
                                    </div>

                                    ...
                                    <div class="modal-body">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="form-group col-3">
                                                ...
                                                <input type="text" class="form-control" id="merk" name="merk" value="<?= $a['merk'] ?>">
                                            </div>
                                            <div class="form-group col-3">
                                                <label for="">No PO</label>
                                                <input type="text" class="form-control" id="no_po" name="no_po" value="<?= $a['no_po'] ?>">
                                            </div>
                                            <div class="form-group col-3">
                                        ...
                                        <div class="row">
                                            <div class="form-group mb-1 col-4">
                                                ...
                                                <input type="text" class="form-control" id="Serial Number" name="serial_number" value="<?= $a['serial_number'] ?>">
                                            </div>
                                            <div class="form-group mb-1 col-4">
                                                <label for="">PT</label>
                                            ...
                                            <div class="form-group mb-1 col-4">
                                                ...
                                                <input type="text" class="form-control" id="lokasi" name="lokasi" value="<?= $a['lokasi'] ?>">
                                            </div>
                                        </div>
                                        <div class=" mt-2">
                                            <label for=""><b>
                                            ...
                                            <div class="row">
                                                <div class="form-group mb-1 col-6">
                                                    <label for="">CPU</label>
                                                    <input type="text" class="form-control" id="CPU" name="cpu" value="<?= $a['cpu'] ?>">
                                                </div>
                                                <div class="form-group mb-1 col-6">
                                                    <label for="">RAM</label>
                                                    <input type="text" class="form-control" id="RAM" name="ram" value="<?= $a['ram'] ?>">
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="form-group mb-1 col-6">
                                                    <label for="">Storage</label>
                                                    <input type="text" class="form-control" id="Storage" name="storage" value="<?= $a['storage'] ?>">
                                                </div>
                                                <div class="form-group mb-1 col-6">
                                                    <label for="">GPU</label>
                                                    <input type="text" class="form-control" id="GPU" name="gpu" value="<?= $a['gpu'] ?>">
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="form-group mb-1 col-6">
                                                    <label for="">Display</label>
                                                    <input type="text" class="form-control" id="Display" name="display" value="<?= $a['display'] ?>">
                                                </div>
                                                <div class="form-group mb-1 col-6">
                                                    <label for="">Lainya</label>
                                                    <input type="text" class="form-control" id="Lain-lain" name="lain" value="<?= $a['lain'] ?>">
                                                </div>
                                            </div>
                                        </div>
                                        <div class=" row">
                                            <div class="form-group mt-3 col-6">
                                                ...
                                                <input type="date" class="form-control" id="tgl_pembelian" name="tgl_pembelian" value="<?= $a['tgl_pembelian'] ?>">
                                            </div>
                                            <div class="form-group mt-3 col-6">
                                        ...
                                        <div class="row">
                                            <div class="form-group col-5">
                                                ...
                                                <input type="text" class="form-control" id="user" name="user" value="<?= $a['user'] ?>">
                                            </div>
                                            <div class="form-group col-5">

                ...
                <?php if ($this->session->userdata('username')) { ?>
                    ...
                    <li>
                        <a href="<?= base_url('Maintenance') ?>">
                            ...
                            <span class="badge badge-danger float-right"><?= $this->db_masis_pt->query("SELECT id_assets FROM tb_assets WHERE status_maintenan = 0 AND tgl_jadwal_maintenan <= '$date_today' AND tgl_jadwal_maintenan != '1970-01-01' ")->num_rows(); ?> </span>
